...
enum class Images(val path: String) {
    ...
    Arts("art.png"),
    Quick("quick.png"),
    CriticalDigit0("critical_digit_0.png"),
    CriticalDigit1("critical_digit_1.png"),
    CriticalDigit2("critical_digit_2.png"),
    CriticalDigit3("critical_digit_3.png"),
    CriticalDigit4("critical_digit_4.png"),
    CriticalDigit5("critical_digit_5.png"),
    CriticalDigit6("critical_digit_6.png"),
    CriticalDigit7("critical_digit_7.png"),
    CriticalDigit8("critical_digit_8.png"),
    CriticalDigit9("critical_digit_9.png"),
    Weak("weak.png"),
    Resist("resist.png"),
    Friend("friend.png"),
    Guest("guest.png"),
